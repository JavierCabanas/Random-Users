...
import me.cabanas.javi.randomusers.di.modules.RepositoryModule
...
@Component(modules = [AndroidSupportInjectionModule::class, ApplicationModule::class,
    RepositoryModule::class, ViewModelModule::class, UserModule::class,
    UserListViewBindingModule::class])
